...
if __name__ == "__main__":
    ...
    train_dst = mxbox.datasets.MNIST('../../Data/', train=True, transform=trans, download=False)
    valid_dst = mxbox.datasets.MNIST('../../Data/', train=False, transform=trans, download=False)
